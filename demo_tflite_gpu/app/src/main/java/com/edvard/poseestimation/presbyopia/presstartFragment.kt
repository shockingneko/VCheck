...
class presstartFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val root = inflater.inflate(R.layout.fragment_presstart, container, false)
        ...
        button1.setOnClickListener {
            ...
            val presintro = presintroFragment()
            trans.replace(R.id.navi_container, presintro)
            trans.commit()
        }
