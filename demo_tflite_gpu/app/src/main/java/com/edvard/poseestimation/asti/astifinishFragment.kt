...
class astifinishFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val root = inflater.inflate(R.layout.fragment_astifinish, container, false)
        ...
        val recommand = root.findViewById<TextView>(R.id.textView20)
